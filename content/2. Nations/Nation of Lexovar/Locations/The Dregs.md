...
| Type | Smuggling Port |
| Head of Port | Vix 'Moldcoin' Brattle |
| Primary Cargo | Stolen fragments, contraband magitech, forged shipping seals, pirate loot, cross-border smuggling |
...
A thin, twitchy gnome with green-stained teeth, a permanently damp coat, and one cloudy glass eye that never points the same direction twice. He is unpleasant, clever, and harder to kill than mold in a cellar. Moldcoin does not command the Dregs through fear or loyalty. He survives because he knows which ships are lying, which guards are paid, and which bodies are buried under the old fish market.
